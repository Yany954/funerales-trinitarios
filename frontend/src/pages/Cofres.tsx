...
export default function Cofres() {
  return (
    <div className="rounded-xl border border-dashed border-vino-100 bg-white p-10 text-center">
      ...
      <p className="font-display text-lg text-vino-900">Módulo de cofres — siguiente paso</p>
      <p className="mx-auto mt-2 max-w-md text-sm text-tinta/60">
        Catalogo de cofres con foto y referencia, por nivel (basico, semilujo, lujo).
      </p>
    </div>
  );
}
