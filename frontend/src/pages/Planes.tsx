...
export default function Planes() {
  return (
    <div className="rounded-xl border border-dashed border-vino-100 bg-white p-10 text-center">
      ...
      <p className="font-display text-lg text-vino-900">Módulo de planes funerarios — siguiente paso</p>
      <p className="mx-auto mt-2 max-w-md text-sm text-tinta/60">
        Planes funerarios (Girasol, Alianza, Bendiciones, Integral) y su mensualidad.
      </p>
    </div>
  );
}
