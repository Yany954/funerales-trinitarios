...
export default function Bovedas() {
  return (
    <div className="rounded-xl border border-dashed border-vino-100 bg-white p-10 text-center">
      ...
      <p className="font-display text-lg text-vino-900">Módulo de bovedas — siguiente paso</p>
      <p className="mx-auto mt-2 max-w-md text-sm text-tinta/60">
        Bovedas arrendadas, con la alerta automatica de vencimiento a los 4 anios.
      </p>
    </div>
  );
}
