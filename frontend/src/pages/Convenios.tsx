...
export default function Convenios() {
  return (
    <div className="rounded-xl border border-dashed border-vino-100 bg-white p-10 text-center">
      ...
      <p className="font-display text-lg text-vino-900">Módulo de convenios — siguiente paso</p>
      <p className="mx-auto mt-2 max-w-md text-sm text-tinta/60">
        Alcaldias, empresas exequiales y sus tarifas por anio (basico, semilujo, lujo, iniciales, finales, traslados).
      </p>
    </div>
  );
}
